...
merchants = {
    ...
    'LIDL #1215': ('Lidl', ExpenseCategory.Groceries),
    ...
    'AMK CAPITAL ONE C3': ('Office cafeteria', ExpenseCategory.Meal),
    'CAPITAL ONE BISTRO 12': ('Office cafeteria', ExpenseCategory.Meal),
    'ASHBURN BIRYANI GR': ('Biryani Grill', ExpenseCategory.Meal),
    'CAPITAL ONE WC COMMONS': ('Office cafeteria (Richmond)', ExpenseCategory.Meal),
    'CAPITAL ONE WC MARKET': ('Office cafeteria (Richmond)', ExpenseCategory.Meal),
    'BAWARCHI': ('Bawarchi', ExpenseCategory.Meal),
    'BABA\'S BIRYANI': ('Baba\'s Biryani', ExpenseCategory.Meal),
    ...
    'BIRYANI GRILL': ('Biryani Grill', ExpenseCategory.Meal),
    'BLUESTONE LANE - 1': ('Bluestone Lane', ExpenseCategory.Meal),
    ...
    '10046D CAVA PIKE 7 PLZ': ('Cava', ExpenseCategory.Meal),
    '10010D CAVA BELMONT': ('Cava', ExpenseCategory.Meal),
    '10024D CAVA STERLING': ('Cava', ExpenseCategory.Meal),
    'CHATEAU DE CHANTI': ('Chateau de Chantilly', ExpenseCategory.Meal),
    'CAFE HYDERABAD CHU': ('Cafe Hyderabad Chutney\'s', ExpenseCategory.Meal),
    'CHAATWALA': ('Chaatwala', ExpenseCategory.Meal),
    'CHESAPEAKE BAGEL': ('Chesapeake Bagel', ExpenseCategory.Meal),
    ...
    'DELHI 6 INDIAN CUISINE': ('Delhi 6', ExpenseCategory.Meal),
    ...
    'JALSA INDIAN RESTAURAN': ('Patel Brothers Food Corner', ExpenseCategory.Meal),
    'KIRANA PASAL': ('Kirana Pasal', ExpenseCategory.Meal),
    ...
    'MOBY DICK HOUSE O': ('Moby Dick', ExpenseCategory.Meal),
    ...
    'NANDOS': ('Nando\'s Peri Peri', ExpenseCategory.Meal),
    'NAYA - PHILLY': ('Naya (Philly)', ExpenseCategory.Meal),
    ...
    'PAPA JOHN\'S #3461': ('Panera Bread', ExpenseCategory.Meal),
    ...
    'REAL FOOD EATERY': ('Real Food Eatery', ExpenseCategory.Meal),
    'SHOES CUP AND CORK': ('Shoe\'s Cup and Cork', ExpenseCategory.Meal),
    'SideBar': ('SideBar', ExpenseCategory.Meal),
    'SPICE VILLAGE': ('Spice Village', ExpenseCategory.Meal),
    ...
    'SWEET LEAF - MCLEA': ('Sweet Leaf', ExpenseCategory.Meal),
    'SWEET LEAF - VIENN': ('Sweet Leaf', ExpenseCategory.Meal),
    'SWEETGREEN': ('Sweet Green', ExpenseCategory.Meal),
    'WATERFRONT GOURMET': ('Waterfront Gourmet', ExpenseCategory.Meal),
    ...
    'TAVAFRYMODER': ('Tava Fry', ExpenseCategory.Meal),
    ...
    'TOOSSO PAKISTANI K': ('Toosso', ExpenseCategory.Meal),
    'WOODLANDS RESTAURANT': ('Woodlands', ExpenseCategory.Meal),
    'YE CHON RESTAURANT': ('Ye Chon', ExpenseCategory.Meal),
    'YECHON': ('Ye Chon', ExpenseCategory.Meal),
    ...
    'DOUGH BUSTERS LLC': ('Aunt Anne\'s', ExpenseCategory.FastFood),
    ...
    'LIL CITY CREAMERY': ('Lil City Creamery', ExpenseCategory.FastFood),
    'VAN LEEUWEN ICE CR': ('Van Leeuwen Ice Cream', ExpenseCategory.FastFood),
    'WOODY`S ICE CREAM': ('Woody\'s Ice Cream', ExpenseCategory.FastFood),

    # House Rent
    'ATLEY': ('Atley', ExpenseCategory.HouseRent),
    ...
    'NYTIMES DISC*': ('NYTimes', ExpenseCategory.BooksAndMagazines),
    ...
    '9657 GREAT CLIPS AT BR': ('Great Clips', ExpenseCategory.AllElse),
    '3348 GREAT CLIPS AT BR': ('Great Clips', ExpenseCategory.AllElse),
    '3178 GREAT CLIPS AT AS': ('Great Clips', ExpenseCategory.AllElse),
